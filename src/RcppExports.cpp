...
RcppExport SEXP _RcppPackage_designTTest(SEXP intsSEXP, SEXP designSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _RcppPackage_permFDRAdjust(SEXP expPsSEXP, SEXP thresholdSEXP, SEXP designSEXP, SEXP intOnlySEXP, SEXP nPermsSEXP, SEXP ncSEXP, SEXP ntSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _RcppPackage_permFDRAdjustCpp(SEXP expPsSEXP, SEXP thresholdSEXP, SEXP designSEXP, SEXP intMatrixSEXP, SEXP nPermsSEXP, SEXP ncSEXP, SEXP ntSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _RcppPackage_rcpp_hello_world() {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_RcppPackage_designTTest", (DL_FUNC) &_RcppPackage_designTTest, 2},
    {"_RcppPackage_permFDRAdjust", (DL_FUNC) &_RcppPackage_permFDRAdjust, 7},
    {"_RcppPackage_permFDRAdjustCpp", (DL_FUNC) &_RcppPackage_permFDRAdjustCpp, 7},
    {"_RcppPackage_rcpp_hello_world", (DL_FUNC) &_RcppPackage_rcpp_hello_world, 0},
    {NULL, NULL, 0}
};

RcppExport void R_init_RcppPackage(DllInfo *dll) {
